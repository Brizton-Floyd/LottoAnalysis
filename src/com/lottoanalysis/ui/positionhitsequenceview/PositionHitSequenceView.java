...
public class PositionHitSequenceView extends BaseView<PositionHitSequencePresenter> {
    ...
    private void buildPositionHitInfoPane(){
        ...
        hBox.getChildren().setAll( stackPane);
    ...
    private void buildMenuBar() {
        ...
        menuBar.getMenus().addAll(drawPositionMenu);
...
//        List<List<Integer>> bollingerBands = bollingerBand.getBollingerBands();
        ...
        LineChartWithHover lc = new LineChartWithHover(dataPoints,
                null,
                minMaxVals.get(0),
                minMaxVals.get(minMaxVals.size() - 1), unique.toString(), "Game Out Trend Analysis For Draw Position " + drawPositionIndex, 654, 346, 8);
...
//        List<List<Integer>> bollingerBands = bollingerBand.getBollingerBands();
        ...
        LineChartWithHover lc = new LineChartWithHover(dataPoints,
                null,
                minMaxVals.get(0),
                minMaxVals.get(minMaxVals.size() - 1), unique.toString(), "Lottery Number Hit Trend Chart ", 654, 346, 8);
