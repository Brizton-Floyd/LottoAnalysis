...
public class GamesOutViewDepicter{
                ...
                for(int g = 0; g < mappingDataTwo.size(); g++){
                    ...
                    for(Map.Entry<Integer,Object[]> dataContents : firsDataTwo.entrySet()){
                        ...
                        if( secondDataTwo.keySet().contains( val ) ){
                            ...
                            // Second data contains the key you are looking for see if the lottogames out for that digit is
                            // less than the lottogames out in the prior draw index
     ...
     * how many lottogames out the number is.The lottogames out data is then put into a list to be analyzed further, a map is then
