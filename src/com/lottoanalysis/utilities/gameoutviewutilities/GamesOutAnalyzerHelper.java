...
public class GamesOutAnalyzerHelper{
     ...
     * the amount of lottogames the lotto number is out
    ...
    /**
     * Method will take in all positions that make up a lotto number. And analyze how many lottogames out lotto number is. As well as the last position
    ...
    /**
     * Method will increment all lottogames out applicable to the lotto numbers contained in a set.
