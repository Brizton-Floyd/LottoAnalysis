...
import static com.lottoanalysis.utilities.GamesOutViewDepicter.incrementGamesOut;
...
public class PositionalGameOutPositionTracker {
    ...
    private static void processDrawStringData(int[][] drawPostions) {
        ...
        for (int i = 0; i < drawPostions.length; i++) {
            // arraylist will hold which games out has occurred in each position and the other arraylist will hold position number last hit in
