...
public class NumberAnalyzer {
    ...
    public static Map<Integer, Map<String, Object[]>> findAverageAndGamesOut(int[] number, boolean inflateAvg) {
        ...
        // See what happens most often at the current lottogames out
    ...
    /**
     *Method Takes in a list of Integers representing winning columns the drawposition hit in and a map holding odd and even value representing odd and even columns hits, and lottogames out.
     *@param columnHits
    ...
    /**
     *Method simply increments lottogames out for all columns that did not yield the correct winning digit for the most recent drawing
     *@param data
     *@param value
     */
